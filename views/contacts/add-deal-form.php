...
<div id="dealSidebar" class="sidebar sidebar-form ">
    ...
    <div class="tab-content-wrapper">
        ...
        <form action="/includes/contacts/link-contact-to-deal.php" method="POST" class="tab-content active" id="new-deal">
        ...
        <form action="/includes/contacts/link-contact-to-deal.php" method="POST" class="tab-content" id="existing-deal">
            <input type="hidden" name="contact_id" value="<?= $contact['contact_id'] ?>">
